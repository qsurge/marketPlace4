import { defineComponent, ref, computed, provide, onMounted, watch, h as h$1, Fragment, onUnmounted, watchEffect, nextTick, toRef, mergeProps, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, renderList, useSSRContext, inject, toRaw } from 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/vue/index.mjs';
import { u as u$1, o as o$1, c, l, K, H, T, t, p as p$1, N } from './open-closed-6ea9de77.mjs';
import { y, w as w$1, h, f as f$2, a as a$2, b, O, o as o$2 } from './hidden-6a6c0b28.mjs';
import _sfc_main$1 from './index-4fdbba8f.mjs';
import __nuxt_component_0 from './Icon-c19bf7f4.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr } from 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/vue/server-renderer/index.mjs';
...
import 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/@iconify/vue/dist/offline.mjs';
import 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/@iconify/vue/dist/iconify.mjs';
...
let Fe = defineComponent({ name: "Listbox", emits: { "update:modelValue": (t2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => fe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(t2, { slots: v, attrs: u2, emit: L }) {
  let e$1 = ref(1), s2 = ref(null), b2 = ref(null), m = ref(null), f2 = ref([]), o2 = ref(""), a2 = ref(null), w$1$1 = ref(1);
  function k(i = (n) => n) {
  ...
  let g2 = computed(() => t2.multiple ? 1 : 0), [y$1, M] = d(computed(() => t2.modelValue === void 0 ? u$1(g2.value, { [1]: [], [0]: void 0 }) : t2.modelValue), (i) => L("update:modelValue", i), computed(() => t2.defaultValue)), h$2 = { listboxState: e$1, value: y$1, mode: g2, compare(i, n) {
    ...
    return t2.by(i, n);
  }, orientation: computed(() => t2.horizontal ? "horizontal" : "vertical"), labelRef: s2, buttonRef: b2, optionsRef: m, disabled: computed(() => t2.disabled), options: f2, searchQuery: o2, activeOptionIndex: a2, activationTrigger: w$1$1, closeListbox() {
    ...
    o2.value = "", a2.value = x$1, w$1$1.value = l2 != null ? l2 : 1, f2.value = d2.options;
  }, search(i) {
    if (t2.disabled || e$1.value === 1)
      return;
    let l2 = o2.value !== "" ? 0 : 1;
    ...
    R === -1 || R === a2.value || (a2.value = R, w$1$1.value = 1);
  }, clearSearch() {
    ...
    f2.value = n.options, a2.value = n.activeOptionIndex, w$1$1.value = 1;
  }, select(i) {
  ...
  y([b2, m], (i, n) => {
    var l2;
    h$2.closeListbox(), w$1(n, h.Loose) || (i.preventDefault(), (l2 = o$1(b2)) == null || l2.focus());
...
//# sourceMappingURL=ThemeSwitcher-4817028e.mjs.map
