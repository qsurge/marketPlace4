globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getQuery as getQuery$1, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/h3/dist/index.mjs';
...
import { extname, join } from 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/pathe/dist/index.mjs';
...
import { preprocess } from 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/micromark/dev/lib/postprocess.js';
...
import { markdownLineEnding, markdownSpace } from 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/agile/Downloads/GA-Nuxt/marketPlace4/node_modules/micromark-util-chunked/dev/index.js';
...
const serverAssets = [{"baseName":"server","dir":"/home/agile/Downloads/GA-Nuxt/marketPlace4/app/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/agile/Downloads/GA-Nuxt/marketPlace4/app/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/agile/Downloads/GA-Nuxt/marketPlace4/app/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/agile/Downloads/GA-Nuxt/marketPlace4/app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/agile/Downloads/GA-Nuxt/marketPlace4/app/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/agile/Downloads/GA-Nuxt/marketPlace4/app/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/agile/Downloads/GA-Nuxt/marketPlace4/app/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _hglGShmW6h = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_46cSZC = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.json', handler: _xLddRi, lazy: false, middleware: false, method: "get" },
...
const getClientManifest = () => import('/home/agile/Downloads/GA-Nuxt/marketPlace4/app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/agile/Downloads/GA-Nuxt/marketPlace4/app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
